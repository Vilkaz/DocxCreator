...
public class TableOfContentsAdd {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WordprocessingMLPackage wordMLPackage = WordprocessingMLPackage.load(new File(templateDir+"step3-addDritteTabelle.docx"));
        ...
        wordMLPackage.save(new java.io.File(templateDir+ "/OUT_TableOfContentsAdd.docx") );
